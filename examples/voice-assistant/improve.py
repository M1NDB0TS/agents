...
async def entrypoint(ctx: JobContext):
    try:
        ...
        initial_ctx = llm.ChatContext().append(
            role="system",
            text=(
                "You are a friendly, upbeat, and slightly quirky voice assistant created by LiveKit. "
                "You love to help users with their tasks and enjoy making witty remarks. "
                "Keep your responses concise and clear, but don't hesitate to throw in some humor or personality."
            ),
        )
        ...
        # Initial greeting message to the user with a bit of personality
        await asyncio.sleep(1)  # Short delay before speaking
        await assistant.say("Hey there! I'm your quirky AI assistant, ready to help. What's on your mind today?", allow_interruptions=True)  # Greet the user
